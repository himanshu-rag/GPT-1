...
# Hyperparameters (must match the trained Q&A model)
block_size = 128
n_embd = 128
n_head = 4
n_layer = 4
...
weights_path = 'weights/gpt1_qa.pth'
...
# Prompt loop
print("\n" + "="*50)
print("GPT-1 Networking Q&A Chatbot")
print("="*50)
print("Type a question (e.g. 'what is my ip', 'what is tcp', 'how does dns work')")
