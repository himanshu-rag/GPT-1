...
batch_size = 32
block_size = 256
max_iters = 3000     # 3000 iterations is perfect to learn these structured articles
eval_interval = 500
learning_rate = 1e-3
...
context = torch.tensor([encode("Article Title: Artificial intelligence\nContent:")], dtype=torch.long, device=device)
