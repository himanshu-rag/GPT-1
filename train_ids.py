...
# 1. Read dataset
data_path = "input_ids.txt"
if not os.path.exists(data_path):
    print("Error: input_ids.txt not found. Run generate_ids_data.py first.")
    exit(1)
...
torch.save(model.state_dict(), 'gpt1_ids.pth')
print("Model weights saved to gpt1_ids.pth")
