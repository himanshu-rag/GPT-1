...
# Hyperparameters (must match the trained code model)
block_size = 256
n_embd = 128
n_head = 4
n_layer = 4
...
weights_path = 'weights/gpt1_code.pth'
...
# Prompt loop
print("\n" + "="*70)
print("GPT-1 Code and Programming Tutor Generator")
print("="*70)
print("Enter a document header (e.g. '# Document: Python Algorithm: Binary', '# Document: Web')")
