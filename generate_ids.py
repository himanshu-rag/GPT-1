...
weights_path = 'weights/gpt1_ids.pth'
...
# Prompt loop
print("\n" + "="*50)
print("GPT-1 IDS Network Log Generator")
print("="*50)
prompt = input("Enter an initial log filter prompt (e.g. 'proto=TCP src=198.51.100.12', 'proto=TCP src=192.168.1.112', 'proto=UDP '): ")
if not prompt:
    prompt = "\n"
