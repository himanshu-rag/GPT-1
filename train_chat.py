...
# 1. Read dataset
data_path = "data/input_chat.txt"
if not os.path.exists(data_path):
    print("Error: data/input_chat.txt not found.")
    exit(1)
...
torch.save(model.state_dict(), 'weights/gpt1_chat.pth')
print("Model weights saved to weights/gpt1_chat.pth")

# 6. Generate sample text
print("\n--- Generating sample greeting response ---")
context = torch.tensor([encode("Instruction: hello\nResponse:")], dtype=torch.long, device=device)
