...
# Hyperparameters (must match the trained networking model)
block_size = 128
n_embd = 128
n_head = 4
n_layer = 4
...
if not os.path.exists(data_path):
    print("Error: data/input_networking.txt not found. Run train_networking.py first.")
    exit(1)
...
weights_path = 'weights/gpt1_networking.pth'
...
# Prompt loop
print("\n" + "="*50)
print("GPT-1 Networking Text Generator")
print("="*50)
prompt = input("Enter a networking starting prompt (e.g. 'TCP ', 'Segment ', 'SYN-RECEIVED '): ")
if not prompt:
    prompt = "\n"
