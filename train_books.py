...
# Hyperparameters
batch_size = 32
block_size = 512     # Context window increased to 512 characters!
max_iters = 1500
eval_interval = 300
learning_rate = 1e-3
...
torch.save(model.state_dict(), 'weights/gpt1_books.pth')
print("Model weights saved to weights/gpt1_books.pth")

# 6. Generate sample text
print("\n--- Generating sample book reasoning passage ---")
context = torch.tensor([encode("Book: Sherlock Holmes: The Sign of Three\nPassage:")], dtype=torch.long, device=device)
